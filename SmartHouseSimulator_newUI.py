...
def draw_devices():
    ...
    timer_radius = 40
    pygame.draw.circle(screen, WHITE, timer_center, timer_radius)
    if microoven_status == 'on' and microoven_time > 0:
        angle = 360 * (microoven_time / 60)  # Assuming max time is 60 seconds
        pygame.draw.arc(screen, RED, (timer_center[0] - timer_radius, timer_center[1] - timer_radius, timer_radius * 2, timer_radius * 2), 0, angle * (3.14 / 180), 3)
